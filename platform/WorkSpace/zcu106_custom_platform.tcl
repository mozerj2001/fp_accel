...
startgroup
  ...
  make_bd_pins_external  [get_bd_pins clk_in_0/clk_p] [get_bd_pins clk_in_0/clk_n]
  connect_bd_net [get_bd_pins clk_in_0/clk] [get_bd_pins clk_wiz_0/clk_in1]
...
place_ports clk_p_0 D15
# set_property IOSTANDARD LVDS_25 [get_ports [list clk_p_0]]
file mkdir ${FP_ROOT}/platform/WorkSpace/zcu106_custom_platform/zcu106_custom_platform.srcs/constrs_1/new
close [ open ${FP_ROOT}/platform/WorkSpace/zcu106_custom_platform/zcu106_custom_platform.srcs/constrs_1/new/pin_constr.xdc w ]
add_files -fileset constrs_1 ${FP_ROOT}/platform/WorkSpace/zcu106_custom_platform/zcu106_custom_platform.srcs/constrs_1/new/pin_constr.xdc
set_property target_constrs_file ${FP_ROOT}/platform/WorkSpace/zcu106_custom_platform/zcu106_custom_platform.srcs/constrs_1/new/pin_constr.xdc [current_fileset -constrset]
