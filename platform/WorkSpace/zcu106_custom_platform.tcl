...
set PROJECT_NAME "zcu106_custom_platform"
set ORIGIN_DIR "."
set PROJECT_DIR "[file normalize "$ORIGIN_DIR/zcu106_custom_platform"]"

# Create project
create_project ${PROJECT_NAME} ./${PROJECT_NAME} -part xczu7ev-ffvc1156-2-e
...
\
  ...
  assign_bd_address -offset 0x82000000 -range 0x00002000 -target_address_space /zynq_ultra_ps_e_0/Data [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  set_property PFM.AXI_PORT {M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"}} [get_bd_cells /ps8_0_axi_periph]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zcu106_custom_platform/zcu106_custom_platform.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
# Build and export platform hardware.
